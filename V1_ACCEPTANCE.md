...
| 10b | Tier 3 is reachable in a sensible time (D19, **unit revised by D71**) | **NOT A FAILURE — awaiting a band, not a measurement.** The long-standing "6.0 against 3–4, FAIL" was an instrument defect (D71): `deploysToTier3` counted every Firm's deployments. Corrected, `0005-pacing` (n=300, era 3) reads **2.0 — below the 3–4 band, not above it.** Progression was never slow. No verdict is drawn from that number either: it is expressed in the unit D71 revised away from. The criterion is **time to tier 3 = 47 min AI / 94–188 min human-adjusted, with 64% of Firms arriving**, and the band is the owner's to set (Q54). `unlockCompletions` untouched throughout |
